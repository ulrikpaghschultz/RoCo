...
package dk.sdu.mmmi.modular.roco2.services;
...
@Singleton
public class Roco2GrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ProgramElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cExternalsAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cExternalsExternalNameParserRuleCall_3_0 = (RuleCall)cExternalsAssignment_3.eContents().get(0);
		private final Assignment cElementsAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cElementsLocalTypeParserRuleCall_4_0 = (RuleCall)cElementsAssignment_4.eContents().get(0);
		
		//Program:
		//	"package" name=ID ";" externals+=ExternalName* elements+=LocalType*;
		...
		public Assignment getExternalsAssignment_3() { return cExternalsAssignment_3; }

		//ExternalName
		public RuleCall getExternalsExternalNameParserRuleCall_3_0() { return cExternalsExternalNameParserRuleCall_3_0; }

		//elements+=LocalType*
		public Assignment getElementsAssignment_4() { return cElementsAssignment_4; }

		//LocalType
		public RuleCall getElementsLocalTypeParserRuleCall_4_0() { return cElementsLocalTypeParserRuleCall_4_0; }
	}
	...
	public class EnsembleElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cExtendsEnsembleAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final CrossReference cExtendsEnsembleEnsembleCrossReference_2_1_0 = (CrossReference)cExtendsEnsembleAssignment_2_1.eContents().get(0);
		private final RuleCall cExtendsEnsembleEnsembleIDTerminalRuleCall_2_1_0_1 = (RuleCall)cExtendsEnsembleEnsembleCrossReference_2_1_0.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cElementsAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cElementsMemberParserRuleCall_4_0 = (RuleCall)cElementsAssignment_4.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_5 = (Keyword)cGroup.eContents().get(5);
		...
		//("extends" extendsEnsemble=[Ensemble])?
		public Group getGroup_2() { return cGroup_2; }

		//"extends"
		public Keyword getExtendsKeyword_2_0() { return cExtendsKeyword_2_0; }

		//extendsEnsemble=[Ensemble]
		public Assignment getExtendsEnsembleAssignment_2_1() { return cExtendsEnsembleAssignment_2_1; }

		//[Ensemble]
		public CrossReference getExtendsEnsembleEnsembleCrossReference_2_1_0() { return cExtendsEnsembleEnsembleCrossReference_2_1_0; }

		//ID
		public RuleCall getExtendsEnsembleEnsembleIDTerminalRuleCall_2_1_0_1() { return cExtendsEnsembleEnsembleIDTerminalRuleCall_2_1_0_1; }
		...
		//Member
		public RuleCall getElementsMemberParserRuleCall_4_0() { return cElementsMemberParserRuleCall_4_0; }
	...
	public class RoleElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cMixinMixinKeyword_1_0 = (Keyword)cMixinAssignment_1.eContents().get(0);
		private final Keyword cRoleKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cNameAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cNameIDTerminalRuleCall_3_0 = (RuleCall)cNameAssignment_3.eContents().get(0);
		private final Group cGroup_4 = (Group)cGroup.eContents().get(4);
		private final Keyword cExtendsKeyword_4_0 = (Keyword)cGroup_4.eContents().get(0);
		private final Assignment cExtendsRoleAssignment_4_1 = (Assignment)cGroup_4.eContents().get(1);
		private final CrossReference cExtendsRoleRoleCrossReference_4_1_0 = (CrossReference)cExtendsRoleAssignment_4_1.eContents().get(0);
		private final RuleCall cExtendsRoleRoleIDTerminalRuleCall_4_1_0_1 = (RuleCall)cExtendsRoleRoleCrossReference_4_1_0.eContents().get(1);
		private final Group cGroup_5 = (Group)cGroup.eContents().get(5);
		private final Keyword cWithinKeyword_5_0 = (Keyword)cGroup_5.eContents().get(0);
		private final Assignment cWithinEnsembleAssignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final CrossReference cWithinEnsembleEnsembleCrossReference_5_1_0 = (CrossReference)cWithinEnsembleAssignment_5_1.eContents().get(0);
		private final RuleCall cWithinEnsembleEnsembleIDTerminalRuleCall_5_1_0_1 = (RuleCall)cWithinEnsembleEnsembleCrossReference_5_1_0.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final Assignment cElementsAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cElementsMemberParserRuleCall_7_0 = (RuleCall)cElementsAssignment_7.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_8 = (Keyword)cGroup.eContents().get(8);
		
		//Role:
		//	abstract?="abstract"? mixin?="mixin"? "role" name=ID ("extends" extendsRole=[Role])? ("within"
		//	withinEnsemble=[Ensemble])? "{" elements+=Member* "}";
		public ParserRule getRule() { return rule; }
		...
		//"mixin"
		public Keyword getMixinMixinKeyword_1_0() { return cMixinMixinKeyword_1_0; }
		...
		//extendsRole=[Role]
		public Assignment getExtendsRoleAssignment_4_1() { return cExtendsRoleAssignment_4_1; }

		//[Role]
		public CrossReference getExtendsRoleRoleCrossReference_4_1_0() { return cExtendsRoleRoleCrossReference_4_1_0; }

		//ID
		public RuleCall getExtendsRoleRoleIDTerminalRuleCall_4_1_0_1() { return cExtendsRoleRoleIDTerminalRuleCall_4_1_0_1; }

		//("within" withinEnsemble=[Ensemble])?
		public Group getGroup_5() { return cGroup_5; }

		//"within"
		public Keyword getWithinKeyword_5_0() { return cWithinKeyword_5_0; }

		//withinEnsemble=[Ensemble]
		public Assignment getWithinEnsembleAssignment_5_1() { return cWithinEnsembleAssignment_5_1; }

		//[Ensemble]
		public CrossReference getWithinEnsembleEnsembleCrossReference_5_1_0() { return cWithinEnsembleEnsembleCrossReference_5_1_0; }

		//ID
		public RuleCall getWithinEnsembleEnsembleIDTerminalRuleCall_5_1_0_1() { return cWithinEnsembleEnsembleIDTerminalRuleCall_5_1_0_1; }
		...
		//Member
		public RuleCall getElementsMemberParserRuleCall_7_0() { return cElementsMemberParserRuleCall_7_0; }
	...
	public class FieldElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cInitialExprParserRuleCall_2_1_0 = (RuleCall)cInitialAssignment_2_1.eContents().get(0);
		...
		//Expr
		public RuleCall getInitialExprParserRuleCall_2_1_0() { return cInitialExprParserRuleCall_2_1_0; }
	...
	public class ExprElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cInternalQualifiedNameParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		...
		public RuleCall getInternalQualifiedNameParserRuleCall_3() { return cInternalQualifiedNameParserRuleCall_3; }
	...
	public class InternalQualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "InternalQualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StatementElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cBasicStatementParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cQualifiedStatementParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//BasicStatement
		public RuleCall getBasicStatementParserRuleCall_0() { return cBasicStatementParserRuleCall_0; }

		//QualifiedStatement
		public RuleCall getQualifiedStatementParserRuleCall_1() { return cQualifiedStatementParserRuleCall_1; }
	}
	...
	public class ForLoopElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cQualifierAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final CrossReference cQualifierScopeDefiningElementCrossReference_4_0 = (CrossReference)cQualifierAssignment_4.eContents().get(0);
		private final RuleCall cQualifierScopeDefiningElementIDTerminalRuleCall_4_0_1 = (RuleCall)cQualifierScopeDefiningElementCrossReference_4_0.eContents().get(1);
		private final Keyword cFullStopKeyword_5 = (Keyword)cGroup.eContents().get(5);
		private final Assignment cSharedAssignment_6 = (Assignment)cGroup.eContents().get(6);
		private final RuleCall cSharedIDTerminalRuleCall_6_0 = (RuleCall)cSharedAssignment_6.eContents().get(0);
		...
		//qualifier=[ScopeDefiningElement]
		public Assignment getQualifierAssignment_4() { return cQualifierAssignment_4; }

		//[ScopeDefiningElement]
		public CrossReference getQualifierScopeDefiningElementCrossReference_4_0() { return cQualifierScopeDefiningElementCrossReference_4_0; }

		//ID
		public RuleCall getQualifierScopeDefiningElementIDTerminalRuleCall_4_0_1() { return cQualifierScopeDefiningElementIDTerminalRuleCall_4_0_1; }

		//"."
		public Keyword getFullStopKeyword_5() { return cFullStopKeyword_5; }

		//shared=ID
		public Assignment getSharedAssignment_6() { return cSharedAssignment_6; }

		//ID
		public RuleCall getSharedIDTerminalRuleCall_6_0() { return cSharedIDTerminalRuleCall_6_0; }
	...
	public class QualifiedStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "QualifiedStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final CrossReference cQualifierScopeDefiningElementCrossReference_0_1_0 = (CrossReference)cQualifierAssignment_0_1.eContents().get(0);
		private final RuleCall cQualifierScopeDefiningElementIDTerminalRuleCall_0_1_0_1 = (RuleCall)cQualifierScopeDefiningElementCrossReference_0_1_0.eContents().get(1);
		...
		private final RuleCall cStatementOperationActivationParserRuleCall_1_0_0 = (RuleCall)cStatementAlternatives_1_0.eContents().get(0);
		private final RuleCall cStatementOperationInhibitParserRuleCall_1_0_1 = (RuleCall)cStatementAlternatives_1_0.eContents().get(1);
		private final RuleCall cStatementModuleConditionalParserRuleCall_1_0_2 = (RuleCall)cStatementAlternatives_1_0.eContents().get(2);
		
		//QualifiedStatement:
		//	(self?="self" | qualifier=[ScopeDefiningElement]) statement=(OperationActivation | OperationInhibit |
		//	ModuleConditional);
		public ParserRule getRule() { return rule; }
		...
		//self?="self" | qualifier=[ScopeDefiningElement]
		...
		//[ScopeDefiningElement]
		public CrossReference getQualifierScopeDefiningElementCrossReference_0_1_0() { return cQualifierScopeDefiningElementCrossReference_0_1_0; }

		//ID
		public RuleCall getQualifierScopeDefiningElementIDTerminalRuleCall_0_1_0_1() { return cQualifierScopeDefiningElementIDTerminalRuleCall_0_1_0_1; }

		//statement=(OperationActivation | OperationInhibit | ModuleConditional)
		public Assignment getStatementAssignment_1() { return cStatementAssignment_1; }

		//OperationActivation | OperationInhibit | ModuleConditional
		public Alternatives getStatementAlternatives_1_0() { return cStatementAlternatives_1_0; }

		//OperationActivation
		public RuleCall getStatementOperationActivationParserRuleCall_1_0_0() { return cStatementOperationActivationParserRuleCall_1_0_0; }

		//OperationInhibit
		public RuleCall getStatementOperationInhibitParserRuleCall_1_0_1() { return cStatementOperationInhibitParserRuleCall_1_0_1; }

		//ModuleConditional
		public RuleCall getStatementModuleConditionalParserRuleCall_1_0_2() { return cStatementModuleConditionalParserRuleCall_1_0_2; }
	}

	public class OperationActivationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "OperationActivation");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OperationInhibitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "OperationInhibit");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ModuleConditionalElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ModuleConditional");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cFullStopKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class UpdateElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cNameIDTerminalRuleCall_0_0 = (RuleCall)cNameAssignment_0.eContents().get(0);
		private final Keyword cFullStopKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Keyword cUpdateKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
	...
	private InternalQualifiedNameElements pInternalQualifiedName;
	...
	private QualifiedStatementElements pQualifiedStatement;
	private OperationActivationElements pOperationActivation;
	private OperationInhibitElements pOperationInhibit;
	private ModuleConditionalElements pModuleConditional;
	...
	@Inject
	public Roco2GrammarAccess(GrammarProvider grammarProvider,
	...
	//InternalQualifiedName:
	//	qualifier=[ScopeDefiningElement] "." name=ID;
	public InternalQualifiedNameElements getInternalQualifiedNameAccess() {
		return (pInternalQualifiedName != null) ? pInternalQualifiedName : (pInternalQualifiedName = new InternalQualifiedNameElements());
	}
	
	public ParserRule getInternalQualifiedNameRule() {
		return getInternalQualifiedNameAccess().getRule();
	}
	...
	//	(self?="self" | qualifier=[ScopeDefiningElement]) statement=(OperationActivation | OperationInhibit |
	//	ModuleConditional);
	public QualifiedStatementElements getQualifiedStatementAccess() {
		return (pQualifiedStatement != null) ? pQualifiedStatement : (pQualifiedStatement = new QualifiedStatementElements());
	}
	
	public ParserRule getQualifiedStatementRule() {
		return getQualifiedStatementAccess().getRule();
	}

	//OperationActivation:
	//	"." operation=Operation;
	public OperationActivationElements getOperationActivationAccess() {
		return (pOperationActivation != null) ? pOperationActivation : (pOperationActivation = new OperationActivationElements());
	}
	
	public ParserRule getOperationActivationRule() {
		return getOperationActivationAccess().getRule();
	}

	//OperationInhibit:
	//	"!" operation=Operation;
	public OperationInhibitElements getOperationInhibitAccess() {
		return (pOperationInhibit != null) ? pOperationInhibit : (pOperationInhibit = new OperationInhibitElements());
	}
	
	public ParserRule getOperationInhibitRule() {
		return getOperationInhibitAccess().getRule();
	}

	//ModuleConditional:
	//	"." conditional=Conditional;
	public ModuleConditionalElements getModuleConditionalAccess() {
		return (pModuleConditional != null) ? pModuleConditional : (pModuleConditional = new ModuleConditionalElements());
	}
	
	public ParserRule getModuleConditionalRule() {
		return getModuleConditionalAccess().getRule();
	}
