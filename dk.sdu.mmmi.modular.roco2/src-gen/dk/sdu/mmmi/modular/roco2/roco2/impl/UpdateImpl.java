 ...
 * <ul>
 *   <li>{@link dk.sdu.mmmi.modular.roco2.roco2.impl.UpdateImpl#getName <em>Name</em>}</li>
 *   <li>{@link dk.sdu.mmmi.modular.roco2.roco2.impl.UpdateImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UpdateImpl extends MemberImpl implements Update
{
  ...
  {
    return Roco2Package.Literals.UPDATE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Roco2Package.UPDATE__NAME, oldName, name));
  }
  ...
  public EList<Statement> getBody()
  {
    if (body == null)
    {
      body = new EObjectContainmentEList<Statement>(Statement.class, this, Roco2Package.UPDATE__BODY);
    }
    return body;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Roco2Package.UPDATE__BODY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Roco2Package.UPDATE__NAME:
        return getName();
      case Roco2Package.UPDATE__BODY:
        return getBody();
    }
