 ...
 * <ul>
 *   <li>{@link dk.sdu.mmmi.modular.roco2.roco2.impl.ValueImpl#getValue <em>Value</em>}</li>
 *   <li>{@link dk.sdu.mmmi.modular.roco2.roco2.impl.ValueImpl#getExtern <em>Extern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueImpl extends ExprImpl implements Value
{
  ...
  {
    return Roco2Package.Literals.VALUE;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Roco2Package.VALUE__VALUE, oldValue, value));
  }
  ...
  public ExternalName getExtern()
  {
    if (extern != null && extern.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Roco2Package.VALUE__EXTERN, oldExtern, extern));
      }
    }
    return extern;
  }
  ...
  public void setExtern(ExternalName newExtern)
  {
    ...
    extern = newExtern;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Roco2Package.VALUE__EXTERN, oldExtern, extern));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Roco2Package.VALUE__VALUE:
        return getValue();
      case Roco2Package.VALUE__EXTERN:
